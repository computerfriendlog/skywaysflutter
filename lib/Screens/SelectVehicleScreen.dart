...
class _SelectVehicleScreenState extends State<SelectVehicleScreen> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Image.asset(height: 25, width: 25, Constants.img_map_marker_final),
                Padding(
                  padding: const EdgeInsets.all(5.0),
                  child: Text(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                  maxLines: 1,
                                    list_estimations[index].type!,style: HelperWidgets.text_heading_16b_grey(),),
                                ],
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(list_estimations[index].seats! , style: HelperWidgets.text_heading_16(),),
                                      SizedBox(width: _width*0.02,),
                                      Image.asset(height:15,width:15, Constants.img_bag),
                                      SizedBox(width: _width*0.02,),
                                      Text(list_estimations[index].small_luggage! , style: HelperWidgets.text_heading_16(),),
                                      SizedBox(width: _width*0.02,),
                                      Image.asset(height:15,width:15, Constants.img_luggage),
                                      Text(list_estimations[index].luggage! , style: HelperWidgets.text_heading_16(),),
                                    ],
                                  ),
                                  /*Image.network(height: _width*0.1,width: _width*0.2,
                                      list_estimations[index].car_image!),*/
                                  Image.asset(height: _width*0.2,width: _width*0.3, Constants.img_logo),
                                    ...
                                    child: Column(
                                      children: [
                                        Text(
                                          ...
                                          overflow: TextOverflow.ellipsis,
                                          softWrap: true,
                                          "ONE WAY: ${list_estimations[index].orig_price!}",
                                          style: const TextStyle(decoration: TextDecoration.lineThrough,fontSize: 14,color: Colors.white,fontWeight: FontWeight.w400),),
                                        Text(
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          softWrap: true,
                                          "ONE WAY: ${list_estimations[index].price!}",
                                    ...
                                    child: Column(
                                      children: [
                                        Text(
                                          ...
                                          overflow: TextOverflow.ellipsis,
                                          softWrap: true,
                                          "RETURN: ${list_estimations[index].orig_return_fare!}",
                                          style: const TextStyle(decoration: TextDecoration.lineThrough,fontSize: 14,color: Colors.white,fontWeight: FontWeight.w400),),
                                        Text(
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          softWrap: true,
                                          "RETURN: ${list_estimations[index].return_fare!}",
                                          style: const TextStyle(fontSize: 14,color: Colors.white,fontWeight: FontWeight.w400),),
            ...
            ):Center(child: Center(child: Text("Data not found",style: HelperWidgets.text_heading_20b(),)) ),
          ],
        ),
      ),
    );
  ...
  getData() async {
    ...
    if(res['RESULT']=="OK" && res['status']==1){
      ...
      print('...............${list_estimations[0].car_image}       ${list_estimations.length}');
      setState(() {});
